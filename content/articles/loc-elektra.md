...
image_gallery: []
postamble: >-
  You can see [Strauss' _Elektra_ at the Lyric Opera of
  Chicago](https://www.lyricopera.org/concertstickets/calendar/2018-2019/elektra-opera-tickets)
  on select dates between now and February 22nd. I recommending reading a little
  Jung before you head to the theater!
preamble: ''
primary_image: >-
  https://res.cloudinary.com/schmopera/image/upload/v1549581054/media/2019/02/sqNinaStemmeELEKTRALyricOperaofChicago.jpg
...
short_description: >-
  Every facet of this production is thoughtful and dramatic, so much so that
  even the actors aren't immune from its terrors. It was announced before
  curtain that Stemme sustained a knee injury during a rehearsal (one look at
  the steeply raked set and you'll wonder the whole cast isn't on crutches!).
