...
primary_image = "https://res.cloudinary.com/schmopera/image/upload/v1774738019/Harry_Bicket_conducting_from_the_harpscord_and_Willaim_Gaunbo_Su_hight_as_Hercules_bukh0q.png"
primary_image_credit = "Harry Bicket, conducting from the harpsicord and William Guanbo Su (right) as Hercules with members of the English Consort and Clarion Choir. Photo: William Termine."
publishDate = "2026-03-28T00:00:00-00:00"
related_articles = [""]
related_companies = [""]
related_people = [""]
short_description = "This is the English Consort after all. Its impeccable musicianship and Bicket's enlightened conducting are not to be taken for granted."
slug = "handels-hercules-marches-solemnly-into-carnegie-hall"
title = "Handel's Hercules marches solemnly into Carnegie Hall"
+++
...
Elevating the performance above its solemn confines was the Clarion Choir. This New York-based vocal ensemble, under the direction of Steven Fox and recruited by Bicket for _Hercules_, possesses seemingly preternatural unity and flat-out gorgeous articulation. Whether in the reverence and magnificence of "O, filial piety" or the rhythmic intricacies of "Jealousy! Infernal pest" in which it functions as a Greek Chorus, the Clarion Choir astounds.

<figure data-type="image">{{% md %}}![](https://res.cloudinary.com/schmopera/image/upload/v1774738019/David_Portillo_Tenor_Hyllus_Alexander_Chance_Countertonor_Lichas_William_Termine_ilnu8q.jpg){{% /md %}}
<figcaption>Tenor David Portillo as Hyllus and countertenor Alexander Chance as Lichas with members of the English Consort and Clarion Choir. Photo: William Termine.</figcaption>
</figure>
