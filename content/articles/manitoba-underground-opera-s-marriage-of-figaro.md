...
related_companies = []
related_people = []
short_description = "As a singer transitioning out of a performing role and into the role of an audience member, board member, and now reviewer, it is surreal to watch a company grow as a spectator on the outside."
