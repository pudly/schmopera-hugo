...
related_companies = [""]
related_people = [""]
short_description = "Each of these pieces worked remarkably well in their current iterations, but each could very well be fleshed out into what I think could be successful additions to the Canadian canon."
slug = "canuck-cantatas-make-the-future-look-bright"
title = "Canuck Cantatas make the future look bright"
+++
Hello, Schmop-Tops, 

Against the Grain Theatre took back to the stage this past weekend at the Redwood Theatre in Toronto's East End, and it felt good to have them back where they belong. Under the new Artistic Direction of librettist Royce Vavrek, and after an appropriate cancellation of _Indians on Vacation_, AtG is back with aplomb and continues its tradition of shaking things up. 

I caught the closing performance of _Canuck Cantatas_, a collection of three short "scenas". The pieces were commissioned by AtG in which composers and librettists were paired up to create some astonishing new works. 

<figure data-type="image">{{% md %}}![](https://res.cloudinary.com/schmopera/image/upload/v1777939013/DSC01842_qby3y8.jpg){{% /md %}}
<figcaption>A scene from Canuck Cantatas, Against the Grain Theatre, 2026. Photo: Lauren Halasz.</figcaption>
</figure>
...
<figure data-type="image">{{% md %}}![](https://res.cloudinary.com/schmopera/image/upload/v1777939014/DSC01925_mobrps.jpg){{% /md %}}
<figcaption>Danika Lorèn in Canuck Cantatas, Against the Grain Theatre, 2026. Photo: Lauren Halasz.</figcaption>
</figure>
...
<figure data-type="image">{{% md %}}![](https://res.cloudinary.com/schmopera/image/upload/v1777939013/DSC01781_rjfp5h.jpg){{% /md %}}
<figcaption>Emma Pennell in Canuck Cantatas, Against the Grain Theatre, 2026. Photo: Lauren Halasz.</figcaption>
</figure>
