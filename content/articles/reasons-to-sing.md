...
It's kind of an exciting new stressor placed on opera. On the one hand, it's lost one of its deadliest weapons because we can't go see things live; on the other hand, we might end up with some serious masterpieces, now that it's a small fish in a pond that unexpectedly got big. Opera created in this new environment will have to pass the "why sing?" test: are you telling a story that is actually enhanced by singing, instead of speech? Does the music pack a punch, even if the audience is virtual? 

Are the characters singing because it's opera, or is it opera because the characters are singing?